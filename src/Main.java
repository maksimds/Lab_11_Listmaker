...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            choiceMenu = SafeInput.getRegExString(in, "\n A: Add an item \n D: Delete an item \n P: Print the list \n Q: Quit", "[AaDdPpQq]");

            switch (choiceMenu) {
                case "A": case "a":
                    userInput = SafeInput.getNonZeroLength(in, "Enter an item to add to the list: ");
                ...
                case "D": case "d":
                    if (menuList.size() > 0) {
                        displayArrayList();
                        listNum = SafeInput.getRangedInt(in, "Enter the number you want to delete: ", 1, menuList.size());
                        listNum = listNum - 1;
